                ...
                <div class="card-body">
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-sm-2 col-form-label">@lang('messages.ads.title')</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="brief" class="col-sm-2 col-form-label">{{ __('frontend.brief') }}</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-1 col-form-label" for="published">@lang('messages.ads.published')</label>
                            <div class="col-sm-1">
                            ...
                            <label class="col-sm-1 col-form-label" for="lang">@lang('messages.ads.lang')</label>
                            <div class="col-sm-2">
                        ...
                        {{-- <div class="form-group row">
                            <label for="video_link" class="col-sm-2 col-form-label">@lang('messages.ads.video_link')</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" wire:model.debounce.500ms="video_link" id="video_link">
                            </div>
                        </div> --}}

                        <livewire:misc.editor/>
