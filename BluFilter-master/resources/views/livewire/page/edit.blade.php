                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="update">
                        <div class="form-group row">
                            <label for="title" class="col-sm-2 col-form-label">@lang('messages.pages.title')</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="brief" class="col-sm-2 col-form-label">@lang('messages.pages.brief')</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" wire:model.debounce.500ms="brief" id="brief">
                                @error('brief') <span class="error">{{ $message }}</span> @enderror
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="d-none col-sm-2 col-form-label" for="image">@lang('messages.general.featured_img')</label>

                            <div class="d-none col-sm-3">
                                <livewire:misc.image-browser/>
                            </div>

                            <label class="col-sm-2 col-form-label" for="published">@lang('messages.pages.published')</label>
                            <div class="col-sm-3">
                            ...
                            <label class="col-sm-2 col-form-label" for="lang">@lang('messages.pages.lang')</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-success waves-effect waves-light" style="width:50%">
                                    @lang('messages.pages.update')
                                </button>
                            </div>
                        </div>
                    </form>
