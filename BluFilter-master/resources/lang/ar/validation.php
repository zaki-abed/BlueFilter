...
return [
    ...
    */
    ...
    'custom' => [
        'name' => [
            'required' => 'يرجى تعبئة حقل الإسم',
        ],
        'email' => [
            'unique' => 'البريد الإلكتروني مستخدم مسبقاً',
            'required' => 'الحقل الخاص بالبريد الإلكتروني مطلوب',
        ...
        'password' => [
            ...
            'min' => 'يجب أن تكون كلمة السر على الأقل :min حرف'
        ],
        'City' => [
        ...
        'phone' => [
            ...
            'integer' => 'يجب ان يكون حقل الهاتف رقما',
            'min' => 'يجب ان يكون حقل الهاتف اكبر من صفر',
        ],
    ],
